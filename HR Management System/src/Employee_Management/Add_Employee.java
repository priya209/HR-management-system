...
{   
    ...
    Add_Employee()
    {
       ...
       ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icon/"));
    ...
    public void actionPerformed(ActionEvent e)
    {
            ...
            if(e.getSource()==b)
            {
               try
               {
                  ...
                  String q = "INSERT INTO employee VALUES ('" + name + "','" + fname + "','" + age + "','" + dob + "','" + address + "','" + phone + "','" + email + "','" + education + "','" + post + "','" + aadhar + "','" + eid + "')";
