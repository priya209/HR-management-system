...
{  
   ...
   Update_Details_Data()
   {
     ...
     ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icon/leave.png"));
     Image img1 = img.getImage().getScaledInstance(300, 500,Image.SCALE_DEFAULT);
     ...
     ch.addMouseListener(new MouseAdapter()
     {
        ...
        public void mouseClicked(MouseEvent arg0)
        {
               try
               {
                   ...
                   ResultSet rest1 = obj2.stmt.executeQuery(q);
                   while(rest1.next())
                   {
               ...
               {
                 System.out.println("The errror is : "+ex);
               }
        }
     }
     );
